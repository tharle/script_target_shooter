...
function GameConfiguration.new()
    ...
    o.limit_vertical = Vector.new(o.resolution_hud.y,CONFIG_RESOLUTION_HEIGHT - 40) -- limit vertical
    o.pigeon_count_type_pigeons = 6
    o.pigeons_amount_by_level = 5
    o.pigeon_width = 44
    o.pigeon_height = 36
    o.pigeon_velocity_animation = 0.5
    o.pigeon_bounds_horizontal = Vector.new(400, 410)
    o.pigeon_bounds_vertical = Vector.new(450, 460)
    o.pigeon_limit_velocity = Vector.new(40, 70)
